export default {
  translation: {
    ...
    'dashboard.subtitle': 'Seguimiento de donaciones y contribuciones voluntarias',
    ...
    'export.includePersonal': 'Incluir direcciones de billetera e información personal',
